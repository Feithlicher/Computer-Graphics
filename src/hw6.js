...
const cylinderMaterial = new THREE.MeshBasicMaterial( {color: 0x0000FF, wireframe: false} );
...
const whingMaterial1 = new THREE.MeshBasicMaterial( {color: 0x9900FF, side: THREE.DoubleSide, wireframe: false} );
...
const whingMaterial2 = new THREE.MeshBasicMaterial( {color: 0x9900FF, side: THREE.DoubleSide, wireframe: false} );
...
const whingMaterial3 = new THREE.MeshBasicMaterial( {color: 0x9900FF, side: THREE.DoubleSide, wireframe: false} );
...
const windowMaterial1 = new THREE.MeshBasicMaterial( { color: 0xffff00, side: THREE.DoubleSide, wireframe: false } );
...
const windowMaterial2 = new THREE.MeshBasicMaterial( { color: 0xffff00, side: THREE.DoubleSide, wireframe: false } );
